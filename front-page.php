    ...
    <section class="queens container">
      ...
      <section class="queen-boxes">
        <div class="queen-box">
          ...
          <button class="button button--light">MEET MILDRED</button>
        </div>
        <div class="queen-box">
          <h3 class="queen-box__heading">
            Mildred
          ...
          <figure class="queen-box__image">
            <img src="/assets/mildred.jpeg" alt="">
          </figure>
          <button class="button button--light">MEET DALIA</button>
        </div>
        <div class="queen-box">
          <h3 class="queen-box__heading">
            Mildred
          ...
          <button class="button button--light">MEET AGNES</button>
        </div>
      </section>    
    </section>
    <section class="testimonial-banner">
      <figure class="testimonial-banner__image testimonial-banner__image--mobile">
        <img src="/assets/testimonial-image.webp" alt="Girl holding dog">
      </figure>
      <div class="testimonial-banner__container">
        ...
        <div class="testimonial-banner__quote">
          ...
          <h5>
            Stone Creek gave me my best friend. Gabie
            set me up with the perfect puppy. Amazing
            process during the adoption process, great
            communication the entire time. Highly
            recommended        
          </h5>
          <p>Dylan R</p>
        </div>
  ...
  <section class="contact-us container">
    ...
    <p>contact form plugin goes here</p>
  </section>
  <?php
    get_footer();
  ?>